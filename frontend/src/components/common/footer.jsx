...
export default function Footer() {
    return (
        <div className='content-medium-16' style={{ background: colors.green5, width: '100%', height: 250, color: colors.primary, padding: '30px 0px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0px 100px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 40, justifyContent: 'center', color: colors.green2 }}>
                    <div>Main screen</div>
                    <div>Sign in</div>
                    <div>Sign up</div>
                </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0px 120px', alignItems: 'center' }}>
