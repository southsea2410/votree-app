...
export default function InputArticle() {
  ...
  return (
    ...
    <div>
        ...
        >
            <Box sx={style} style={{ height: modalHeight, width: modalWidth, display: 'flex' }}>
              <div className='subtitle-extra-bold upper-case' style={{ 
                display: 'flex',
                alignItems: 'center',
              ...
              <div style={{ height: '100vh', background: colors.primary, borderRadius: 7, marginTop: 31, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                >
                  <TextField fullWidth placeholder='My plant is...' id="fullWidth" InputLabelProps={{ className: 'content-medium-22' }} multiline rows={10} />
                </Box>
                ...
                <div style={{ paddingBottom: '25px', paddingLeft: '38px', paddingRight: '38px' }}>
