...
export default function ProductCard() {
  ...
  return (
    <Card variant='product' style={{
      ...
      />
      <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: 348, height: 93, padding: '7px 20px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', justifyContent: 'space-between' }}>
            <div class="content-medium-14-22">
                17.000.000 VND
            </div>
