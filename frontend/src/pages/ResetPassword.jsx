    ...
    return (
        <div className="containerStyle">
            <div style={{ 
                ...
                <div style={{ width: 422, height: 487, border: '1px solid', borderRadius: 7 }}>
                    <div style={{ ...clusterStyle, padding: '35px 35px' }}>
                        ...
                        {sentOTP ? 
                            ...
                            <form style={{ display: 'flex', flexDirection: 'column', width: '100%', gap: 15 }}>
                        ...
                        :
                            ...
                            <TextField
                                ...
                                style={textBoxStyle}
                            />
                            <Button style={{ width: '100%' }} onClick={handleSendOTP}>Send OTP</Button>
                            <div className='content-semi-bold-14-22'>
